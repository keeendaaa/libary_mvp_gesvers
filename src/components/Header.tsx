        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center gap-3 md:gap-8">
            <div className="flex items-center gap-2 md:gap-3">
              <div className="w-10 h-10 md:w-12 md:h-12 border-2 border-black flex items-center justify-center relative">
                {/* Corner marks */}
                <div className="absolute top-0 left-0 w-1.5 h-1.5 md:w-2 md:h-2 bg-black"></div>
                <div className="absolute top-0 right-0 w-1.5 h-1.5 md:w-2 md:h-2 bg-black"></div>
                <div className="absolute bottom-0 left-0 w-1.5 h-1.5 md:w-2 md:h-2 bg-black"></div>
                <div className="absolute bottom-0 right-0 w-1.5 h-1.5 md:w-2 md:h-2 bg-black"></div>
              ...
              <div>
                <div className="text-sm md:text-lg tracking-tight leading-none mb-0.5 md:mb-1">БИБЛИОТЕКА</div>
                <div className="text-[10px] md:text-xs tracking-wider text-black/60">СИСТЕМА.V2</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-6">
            {user ? (
              <>
                ...
                {/* Mobile user initial */}
                <div className="md:hidden w-10 h-10 border border-black flex items-center justify-center">
                  <span className="text-sm">{user.name.charAt(0)}</span>
                </div>
                <button
                  onClick={onLogout}
                  className="w-9 h-9 md:w-10 md:h-10 border border-black hover:bg-black hover:text-white transition-colors flex items-center justify-center"
                  title="Выйти"
                >
              ...
              <button
                ...
                className="px-4 py-2 md:px-6 md:py-3 border-2 border-black hover:bg-black hover:text-white transition-colors tracking-wider text-xs md:text-sm"
              >
                ВХОД
              </button>
            )}
