          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-12 gap-8 mb-16">
              <div className="col-span-12 lg:col-span-7">
                <div className="mb-8">
                  <div className="inline-block px-4 py-1 border border-black mb-6 text-xs tracking-wider">
                    СИСТЕМА / LIBRARY.V2
                  </div>
                  <h1 className="text-6xl lg:text-7xl tracking-tight mb-6 leading-none">
                ...
                <button 
                  ...
                  className="group relative inline-flex items-center gap-3 px-8 py-4 border-2 border-black hover:bg-black hover:text-white transition-colors"
                >
                ...
                <div className="mt-12 grid grid-cols-8 gap-2 max-w-md">
                  <div className="h-16 bg-black"></div>
                  <div className="h-16 border border-black"></div>
                  <div className="h-16 border border-black"></div>
              ...
              <div className="col-span-12 lg:col-span-5">
                <div className="border-2 border-black p-8 space-y-6">
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="text-6xl tracking-tighter mb-2">8543</div>
                      <div className="text-xs tracking-wider">КНИГИ В КАТАЛОГЕ</div>
                    </div>
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="text-6xl tracking-tighter mb-2">1247</div>
                      <div className="text-xs tracking-wider">ЧИТАТЕЛИ</div>
                    </div>
                    <div className="w-16 h-16 border border-black flex items-center justify-center">
                      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="pt-4">
                    <div className="grid grid-cols-6 gap-1">
                      {Array.from({ length: 18 }).map((_, i) => (
                        <div 
                          key={i} 
                          className={`h-3 ${i % 5 === 0 ? 'bg-black' : 'border border-black/20'}`}
                        ></div>
                      ))}
                    </div>
                  </div>
